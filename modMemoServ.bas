    ...
    Case "help"
        ...
        Else
            Select Case LCase(Msg)
                ...
                Case "list"
                    SendNotice User.Nick, "List", "MemoServ"
                    SendNotice User.Nick, "Lists all your memos", "MemoServ"
                Case "delete"
                    SendNotice User.Nick, "Delete [Memo index]", "MemoServ"
...
If (Not (NickToObject(Target) Is Nothing)) And NickToObject(Target).Identified Then SendNotice Target, "You have a new Memo, type '/msg MemoServ list'", "MemoServ"
End Sub
